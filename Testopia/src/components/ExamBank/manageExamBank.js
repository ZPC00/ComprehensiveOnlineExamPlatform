...
function ManageExamBank() {
  ...
  //load the exam question from back end service
    useEffect(() => {
      if(demoMode){
        ...
        axios.get('https://testopiabackend.onrender.com/getExamBank')
          .then(response => {
  ...
  const handleDeleteQuestion = (id) => {
    if (!showConfirmation) {
      ...
      if(demoMode){
        ...
        axios
          .post('https://testopiabackend.onrender.com/deleteExamQuestion', { id })
        .then((response) => {
  ...
  const handleSaveChanges = () => {
    ...
    if (updatedInfo.id) {
      ...
      axios
        .post("https://testopiabackend.onrender.com/saveExamQusetion", updatedInfo)
        .then((response) => {
          setExamBank(response.data.updatedExamQuestion);
          setOutSuccess(response.data.message);
          setTimeout(() => {
  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = (e) => {
      ...
      if(demoMode){
        ...
        axios
          .post("https://testopiabackend.onrender.com/excelExamUpdate", excelUpdateData)
        .then((response) => {
          setExamBank(response.data.updatedExamQuestion);
